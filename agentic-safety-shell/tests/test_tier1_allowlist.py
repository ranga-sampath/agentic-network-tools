...
@pytest.mark.parametrize("command", [
    ...
    pytest.param("arp --device eth0 -a", id="T1.41"),
...
@pytest.mark.parametrize("command,expected", [
    ...
    pytest.param("tshark -r capture.pcap -w /etc/hosts", CLASSIFICATION_RISKY, id="T1.86"),
    pytest.param("tshark -r capture.pcap -w/etc/hosts", CLASSIFICATION_RISKY, id="T1.87"),
    pytest.param("tcpdump -r capture.pcap -w /etc/passwd", CLASSIFICATION_RISKY, id="T1.88"),
